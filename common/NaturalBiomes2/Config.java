...
public class Config
{
	...
	public static void allowBiomes(){
		...
		BiomeAllow.EXTREME_BIRCH_WOODS = config.get(Strings.CATEGORY_BIOME, Strings.EXTREME_BIRCH_WOODS, BiomeAllow.EXTREME_BIRCH_WOODS_DEFAULT).getBoolean(BiomeAllow.EXTREME_BIRCH_WOODS_DEFAULT);
        BiomeAllow.EXTREME_DESERT_HILLS = config.get(Strings.CATEGORY_BIOME, Strings.EXTREME_DESERT_HILLS, BiomeAllow.EXTREME_DESERT_HILLS_DEFAULT).getBoolean(BiomeAllow.EXTREME_DESERT_HILLS_DEFAULT);
        BiomeAllow.EXTREME_DUNES = config.get(Strings.CATEGORY_BIOME, Strings.EXTREME_DUNES, BiomeAllow.EXTREME_DUNES_DEFAULT).getBoolean(BiomeAllow.EXTREME_DUNES_DEFAULT);
        BiomeAllow.EXTREME_FORESTED_HILLS = config.get(Strings.CATEGORY_BIOME, Strings.EXTREME_FORESTED_HILLS, BiomeAllow.EXTREME_FORESTED_HILLS_DEFAULT).getBoolean(BiomeAllow.EXTREME_FORESTED_HILLS_DEFAULT);
        BiomeAllow.EXTREME_GRASS_HILLS = config.get(Strings.CATEGORY_BIOME, Strings.EXTREME_GRASS_HILLS, BiomeAllow.EXTREME_GRASS_HILLS_DEFAULT).getBoolean(BiomeAllow.EXTREME_GRASS_HILLS_DEFAULT);
        BiomeAllow.EXTREME_PINE_HILLS = config.get(Strings.CATEGORY_BIOME, Strings.EXTREME_PINE_HILLS, BiomeAllow.EXTREME_PINE_HILLS_DEFAULT).getBoolean(BiomeAllow.EXTREME_PINE_HILLS_DEFAULT);
        BiomeAllow.EXTREME_SNOW_HILLS = config.get(Strings.CATEGORY_BIOME, Strings.EXTREME_SNOW_HILLS, BiomeAllow.EXTREME_SNOW_HILLS_DEFAULT).getBoolean(BiomeAllow.EXTREME_SNOW_HILLS_DEFAULT);
        BiomeAllow.EXTREME_SPARSE_WOODS = config.get(Strings.CATEGORY_BIOME, Strings.EXTREME_SPARSE_WOODS, BiomeAllow.EXTREME_SPARSE_WOODS_DEFAULT).getBoolean(BiomeAllow.EXTREME_SPARSE_WOODS_DEFAULT);
        BiomeAllow.EXTREME_BIRCH_WOODS = config.get(Strings.CATEGORY_BIOME, Strings.EXTREME_BIRCH_WOODS, BiomeAllow.EXTREME_BIRCH_WOODS_DEFAULT).getBoolean(BiomeAllow.EXTREME_BIRCH_WOODS_DEFAULT);
        BiomeAllow.MASSIVE_HILLS = config.get(Strings.CATEGORY_BIOME, Strings.MASSIVE_HILLS, BiomeAllow.MASSIVE_HILLS_DEFAULT).getBoolean(BiomeAllow.MASSIVE_HILLS_DEFAULT);
	}
	...
	public static void allowVillages(){
		...
		VillageAllow.EXTREME_BIRCH_WOODS = config.get(Strings.CATEGORY_BIOME, Strings.EXTREME_BIRCH_WOODS, VillageAllow.EXTREME_BIRCH_WOODS_DEFAULT).getBoolean(VillageAllow.EXTREME_BIRCH_WOODS_DEFAULT);
        VillageAllow.EXTREME_DESERT_HILLS = config.get(Strings.CATEGORY_BIOME, Strings.EXTREME_DESERT_HILLS, VillageAllow.EXTREME_DESERT_HILLS_DEFAULT).getBoolean(VillageAllow.EXTREME_DESERT_HILLS_DEFAULT);
        VillageAllow.EXTREME_DUNES = config.get(Strings.CATEGORY_BIOME, Strings.EXTREME_DUNES, VillageAllow.EXTREME_DUNES_DEFAULT).getBoolean(VillageAllow.EXTREME_DUNES_DEFAULT);
        VillageAllow.EXTREME_FORESTED_HILLS = config.get(Strings.CATEGORY_BIOME, Strings.EXTREME_FORESTED_HILLS, VillageAllow.EXTREME_FORESTED_HILLS_DEFAULT).getBoolean(VillageAllow.EXTREME_FORESTED_HILLS_DEFAULT);
        VillageAllow.EXTREME_GRASS_HILLS = config.get(Strings.CATEGORY_BIOME, Strings.EXTREME_GRASS_HILLS, VillageAllow.EXTREME_GRASS_HILLS_DEFAULT).getBoolean(VillageAllow.EXTREME_GRASS_HILLS_DEFAULT);
        VillageAllow.EXTREME_PINE_HILLS = config.get(Strings.CATEGORY_BIOME, Strings.EXTREME_PINE_HILLS, VillageAllow.EXTREME_PINE_HILLS_DEFAULT).getBoolean(VillageAllow.EXTREME_PINE_HILLS_DEFAULT);
        VillageAllow.EXTREME_SNOW_HILLS = config.get(Strings.CATEGORY_BIOME, Strings.EXTREME_SNOW_HILLS, VillageAllow.EXTREME_SNOW_HILLS_DEFAULT).getBoolean(VillageAllow.EXTREME_SNOW_HILLS_DEFAULT);
        VillageAllow.EXTREME_SPARSE_WOODS = config.get(Strings.CATEGORY_BIOME, Strings.EXTREME_SPARSE_WOODS, VillageAllow.EXTREME_SPARSE_WOODS_DEFAULT).getBoolean(VillageAllow.EXTREME_SPARSE_WOODS_DEFAULT);
        VillageAllow.EXTREME_BIRCH_WOODS = config.get(Strings.CATEGORY_BIOME, Strings.EXTREME_BIRCH_WOODS, VillageAllow.EXTREME_BIRCH_WOODS_DEFAULT).getBoolean(VillageAllow.EXTREME_BIRCH_WOODS_DEFAULT);
        VillageAllow.MASSIVE_HILLS = config.get(Strings.CATEGORY_BIOME, Strings.MASSIVE_HILLS, VillageAllow.MASSIVE_HILLS_DEFAULT).getBoolean(VillageAllow.MASSIVE_HILLS_DEFAULT);
	}
}
