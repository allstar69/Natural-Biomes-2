...
public class BiomeAllow {
	...
	//Default Biome On
	public static boolean BIRCH_FOREST_DEFAULT = true;
    ...
    public static boolean BLACK_MARSH_DEFAULT = true;
    public static boolean DUNES_DEFAULT = true;
    public static boolean DESERT_MOUNTAINS_DEFAULT = true;
    public static boolean FOREST_DEFAULT = true;
    public static boolean FOREST_MOUNTAINS_DEFAULT = true;
    public static boolean EMPTY_PLAINS_DEFAULT = true;
    ...
    public static boolean MINI_JUNGLE_DEFAULT = true;
    ...
    public static boolean SNOWY_MOUNTAINS_DEFAULT = true;
	...
	public static boolean SWAMPY_JUNGLE_DEFAULT = true;
    public static boolean TAIGA_MOUNTAINS_DEFAULT = true;
    ...
    public static boolean MINI_JUNGLE;
    ...
    public static boolean SNOWY_MOUNTAINS;
	...
	public static boolean SWAMPY_JUNGLE;
    public static boolean TAIGA_MOUNTAINS;
