...
public class BiomeIds {
    ...
    public static int EXTREME_BIRCH_WOODS_DEFAULT = 32;
    public static int EXTREME_DESERT_HILLS_DEFAULT = 33;
    public static int EXTREME_DUNES_DEFAULT = 34;
    public static int EXTREME_FORESTED_HILLS_DEFAULT = 35;
    public static int EXTREME_GRASS_HILLS_DEFAULT = 36;
    public static int EXTREME_MEADOW_HILLS_DEFAULT = 37;
    public static int EXTREME_WOODS_DEFAULT = 38;
    public static int EXTREME_PINE_HILLS_DEFAULT = 39;
    public static int EXTREME_SNOW_HILLS_DEFAULT = 40;
    public static int EXTREME_SPARSE_WOODS_DEFAULT = 41;
    public static int LUSH_FOREST_DEFAULT = 42;
