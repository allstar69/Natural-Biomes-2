...
public class Strings {
	...
	//Biome Names
	public static final String RAIN_FOREST = "rainForest";
	public static final String BIRCH_JUNGLE = "birchJungle";
	public static final String OAK_WOODS = "oakWoods";
	public static final String THICK_WOODS = "thickWoods";
	public static final String SPARSE_WOODS = "sparseWoods";
	public static final String SNOWY_WOODS = "snowyWoods";
	public static final String LUSH_PLAINS = "lushPlains";
	public static final String LUSH_MOUNTAINS = "lushMountains";
	public static final String PINE_FOREST = "pineForest";
	public static final String MEADOWS = "meadows";
	public static final String SHRUBLANDS = "shrublands";
	public static final String SNOWY_SHRUBLANDS = "snowyShrublands";
	public static final String MARSH = "marsh";
	public static final String SAVANNAH = "savannah";
	public static final String BIRCH_WOODS = "birchWoods";
	public static final String OAK_MOUNTAINS = "oakMountains";
	public static final String THICK_OAK_MOUNTAINS = "thickOakMountains";
	public static final String SPARSE_OAK_MOUNTAINS = "sparseOakMounatains";
	public static final String SNOWY_OAK_MOUNTAINS = "snowyOakMountains";
	public static final String BIRCH_MOUNTAINS = "birchMountains";
	public static final String DUNES = "dunes";
	public static final String THICK_SWAMP = "thickSwamp";		
	public static final String LUSH_FOREST = "lushForest";
	public static final String LUSH_SWAMP = "lushSwamp";
