...
public class Config
{
	...
	public static void biomeIds()
	{
        ...
        BiomeIds.SWAMPY_JUNGLE = config.get(Strings.CATEGORY_BIOME, Strings.SWAMPY_JUNGLE, BiomeIds.SWAMPY_JUNGLE_DEFAULT).getInt(BiomeIds.SWAMPY_JUNGLE_DEFAULT);
	}
	...
	public static void allowBiomes(){
        ...
        BiomeAllow.SWAMPY_JUNGLE = config.get(Strings.CATEGORY_BIOME_ON, Strings.SWAMPY_JUNGLE, BiomeAllow.SWAMPY_JUNGLE_DEFAULT).getBoolean(BiomeAllow.SWAMPY_JUNGLE_DEFAULT);
	}
}
