        ...
        for (aint1[par5] = aint[par5]; j1 <= i1; ++j1)
        {
            ...
            while (k1 <= i1)
            {
                ...
                else
                {
                    ...
                    {
                        this.setBlockAndMetadata(this.worldObj, aint1[0], aint1[1], aint1[2], par6, metaLeaf);
                        ++k1;
                    }
                }
            }
    ...
    void placeBlockLine(int[] par1ArrayOfInteger, int[] par2ArrayOfInteger, int par3)
    {
        ...
        if (aint2[b1] != 0)
        {
            ...
            for (int k = aint2[b1] + b4; j != k; j += b4)
            {
                ...
                this.setBlockAndMetadata(this.worldObj, aint3[0], aint3[1], aint3[2], par3, metaWood);
            }
        }
    }
