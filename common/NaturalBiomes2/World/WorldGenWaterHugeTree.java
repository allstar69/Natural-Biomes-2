...
public class WorldGenWaterHugeTree extends WorldGenerator
{
    ...
    public WorldGenWaterHugeTree(boolean par1, int par2, int par3, int par4)
    {
        super(par1);
    ...
    public boolean generate(World par1World, Random par2Random, int par3, int par4, int par5)
    {
        ...
        if (par4 >= 1 && par4 + l + 1 <= 256)
        {
            ...
            {     
                int block_id = par1World.getBlockId(par3, par4 - 1, par5);
            	boolean onWater = block_id == Block.waterMoving.blockID || block_id == Block.waterStill.blockID;
            	
                if (onWater && par4 < 256 - l - 1)
                {
    ...
    private void changeToWood(World world, int x, int y, int z)
    {
    	this.setBlockAndMetadata(world, x, y, z, Block.wood.blockID, this.woodMetadata);
    }
}
