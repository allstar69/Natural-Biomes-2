...
public class WorldGenWaterTrees extends WorldGenerator
{
    ...
    public WorldGenWaterTrees(boolean par1)
    {
        this(par1, 4, 0, 0, false);
    }

    public WorldGenWaterTrees(boolean par1, int par2, int par3, int par4, boolean par5)
    {
        super(par1);
